package com.example.parkingmonitor.sockets;
...
public class ParkingUpdater extends AsyncTask<Switch, Integer, String> {
    ...
    public String getParkingsState() {
        String state = "";
        ...
        try {
            ...
            Log.i(TAG, "getParkingsStat: " +  state);
